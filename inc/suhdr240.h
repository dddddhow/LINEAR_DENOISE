...
typedef struct {	/* segy - trace identification header */
	...
	//float d1;	/* sample spacing for non-seismic data byte# 181-184*/
	//float f1;	/* first sample location for non-seismic data byte# 185-188 */
	//float d2;	/* sample spacing between traces byte# 189-192*/
	//float f2;	/* first trace location byte# 193-196*/

    int cdpx;       //byte# 181-184  XP_LOCAL
    int cdpy;       //byte# 185-188  XP_LOCAL
    int in_line;    //byte# 189-192  XP_LOCAL
    int cr_line;     //byte# 193-196  XP_LOCAL



	float ungpow;	/* negative of power used for dynamic range compression byte# 197-200*/
	float unscale;	/* reciprocal of scaling factor to normalize range byte# 201-204*/
    int ntr; 	/* number of traces byte# 205-208*/
    short mark;	/* mark selected traces byte# 209-210*/
    short shortpad; /* alignment padding  byte# 211-212*/
